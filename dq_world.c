...
int world_init_game(void)
{
    ...
    */
    ...
    gamepad_down    = &world_action_down;
    gamepad_up      = &world_action_up;
    gamepad_left    = &world_action_left;
    gamepad_right   = &world_action_right;
    gamepad_b0      = &world_action_select;
    gamepad_b1      = &world_action_cancel;
    gamepad_b2      = &world_action_interact;
    gamepad_b3      = &world_action_interact;
    gamepad_b4      = &world_action_unbound;
    gamepad_b5      = &world_action_unbound;
    gamepad_b6      = &world_action_unbound;
    gamepad_b7      = &world_action_unbound;
